...
app.route(env.API_PREFIX + "/addProduct").post(upload.array("image"), Ctrl.addProduct);
app.route(env.API_PREFIX + "/updateProduct/:id").put(upload.array("image"), Ctrl.updateProduct);
